...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView cardView = (CardView)findViewById(R.id.card_res);
...
//                PorterDuff.Mode.SRC_ATOP);
        ...
        navigationView.getMenu().findItem(R.id.feed).getIcon().setColorFilter(Color.parseColor("#222222"),
                PorterDuff.Mode.SRC_ATOP);
        navigationView.getMenu().findItem(R.id.about_us).getIcon().setColorFilter(Color.parseColor("#222222"),
                PorterDuff.Mode.SRC_ATOP);
        navigationView.getMenu().findItem(R.id.share).getIcon().setColorFilter(Color.parseColor("#222222"),
                PorterDuff.Mode.SRC_ATOP);
